...
const initialTemplatesData = [
    ...
    { id: 5, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['https://i.ibb.co/Jj09Pc1r/wedding-invitation-tamplate.jpg'], downloadFormats: { PSD: 'https://drive.google.com/file/d/1FloCAxC6yS2oDqmxG6bMdW54XkawulBj/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1PMNoWGuMi8V0xpOW1tMP8C6xtZS_4F88/view?usp=sharing' }, category: 'Invitations', likes: 481 },
    { id: 6, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['https://i.ibb.co/Mxr6qg9S/wedding-invitation-tamplate-2.jpg'], downloadFormats: { PSD: 'https://drive.google.com/file/d/17kkYdULTchx7GnSJ2QfIf5rKbfKguLcl/view?usp=sharing', JPG: 'https://drive.google.com/file/d/16kualdL7QjmYuFm99Ets7csoUoiktemf/view?usp=sharing' }, category: 'Invitations', likes: 481 },
    { id: 7, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['https://i.ibb.co/VcdTrZbr/wedding-invitation-tamplate-3.jpg'], downloadFormats: { PSD: 'https://drive.google.com/file/d/1CXR71t0f85BfGP-mAlZ9Eqk8CBTbMj9j/view?usp=sharing', JPG: 'https://drive.google.com/file/d/11dfkvdFUxLH2CQwTcVNDyR6b8sUT69SP/view?usp=sharing' }, category: 'Invitations', likes: 481 },
    { id: 8, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['https://i.ibb.co/hxW9Z1R2/wedding-invitation-tamplate-5.jpg'], downloadFormats: { PSD: 'https://drive.google.com/file/d/1oknQgcFKigEl7YVPw6hB-tXbvUJcQjPi/view?usp=sharing', JPG: 'https://drive.google.com/file/d/17EM79qr8dlEB5oKNeE3ZRq9c2iMJiwM5/view?usp=sharing' }, category: 'Invitations', likes: 481 },
    { id: 9, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['https://i.ibb.co/twbgvCJG/wedding-invitation-tamplate-6.jpg'], downloadFormats: { PSD: 'https://drive.google.com/file/d/1GbELy1c757dWn4xLCujO09Vr4QVzthdc/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1J-LEncEzpuUF0R_eAMWQpkbXfZYGda18/view?usp=sharing' }, category: 'Invitations', likes: 481 },
    { id: 10, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['https://i.ibb.co/213XmTWk/wedding-invitation-tamplate-4.jpg'], downloadFormats: { PSD: 'https://drive.google.com/file/d/1Xf-rZCuaJu2eCtmb5TeugXdLOTSy7btw/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1tUPT8NIQcMRuQyxRLRQxpZg2hXYdCKeb/view?usp=sharing' }, category: 'Invitations', likes: 481 },
    { id: 11, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['https://i.ibb.co/q3Fk5X32/wedding-invitation-tamplate-7.jpg'], downloadFormats: { PSD: 'https://drive.google.com/file/d/1-gvnEP6ocCT1MXToLqgjz6dABL_jPfyo/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1bNfFhI1uo_wiWC4--K6A7FCB_GI4uIi2/view?usp=sharing' }, category: 'Invitations', likes: 481 },
    { id: 12, name: 'Classic Invitation Template', price: '80', paymentLink: '#', previewImages: ['#'], downloadFormats: { PSD: '#', JPG: '#' }, category: 'Invitations', likes: 481 },
    // Yahan aur Invitations templates jod sakte hain

    // =================================================================
    // ===================== SAVE-THE-DATE CATEGORY ====================
    // =================================================================
    { id: 1001, name: 'Modern Geometric Save-the-Date', price: '99', paymentLink: '#', previewImages: ['https://images.unsplash.com/photo-1560962827-2a68f4e20557?q=80&w=1887&auto=format&fit=crop'], downloadFormats: { EPS: '#', PNG: '#' }, category: 'Save-the-Date', likes: 198 },
    { id: 1002, name: 'Vintage Save-the-Date Postcard', price: '149', paymentLink: '#', previewImages: ['https://images.unsplash.com/photo-1530053335839-a35af3d7a8d5?q=80&w=1887&auto=format&fit=crop'], downloadFormats: { PNG: '#', JPG: '#' }, category: 'Save-the-Date', likes: 345 },
    // Yahan aur Save-the-Date templates jod sakte hain

    // =================================================================
    // ======================== CLIPART CATEGORY =======================
    // =================================================================
    { id: 2001, name: 'Wedding couple Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/twRmgSRQ/wedding-couple-Illutraction-67.jpg'], downloadFormats: { PNG: 'https://drive.google.com/file/d/1F3KaJ3DM_ujUI3GvV9D1pP60eu-K05RX/view?usp=sharing', EPS: 'https://drive.google.com/file/d/1zQ6WgAF1TiJJSj_hUeRXAsKLO8K9LtPy/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1BbAezaAna-BnWhKbS4rfm2EYMY54jPkl/view?usp=sharing' }, category: 'Clipart', likes: 88 },
    { id: 2002, name: 'Just Married Car Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/5gj7xmyT/wedding-couple-Illutraction-66.jpg'], downloadFormats: { PNG: 'https://drive.google.com/file/d/17Ye3NKyku0EEbG_0Ytkb9WQW60FfY0m0/view?usp=sharing', EPS: 'https://drive.google.com/file/d/1Aw3-u9zAW2gp-LQATC4PT9n7m151ucDU/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1QMKznT7OPIOmX6y2FLE8gyu29UrGUcCr/view?usp=sharing' }, category: 'Clipart', likes: 123 },
    { id: 2003, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/spTTffW7/wedding-couple-Illutraction-65.jpg'], downloadFormats: { PNG: 'https://drive.google.com/file/d/19jH3-VlERrLez3p2fDjI47icGUl_r5AH/view?usp=sharing', EPS: 'https://drive.google.com/file/d/1o9Vkcf0eRia2ZBKjj2W9lvsB5jgARdra/view?usp=sharing', JPG: 'https://drive.google.com/file/d/13DOC_xRcwwm9i4dipAKPqFggfOPVtCf4/view?usp=sharing' }, category: 'Clipart', likes: 210 },
    { id: 2004, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/KjShRcLM/wedding-couple-Illutraction-64.jpg'], downloadFormats: { PNG: 'https://drive.google.com/file/d/186Pu9G4r_R30Vx8aiwgbwOX1yetp1oEk/view?usp=sharing', EPS: 'https://drive.google.com/file/d/1IuQCYoK3VB-rj5wcsVqI2v2bAH0-brVn/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1C48QboOGfA2Duim2CVjycTQuzs6UcRDq/view?usp=sharing' }, category: 'Clipart', likes: 210 },
    { id: 2005, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/zTn9X47H/wedding-couple-Illutraction-63.jpg'], downloadFormats: { PNG: 'https://drive.google.com/file/d/1XwlDXNMgehZH84alkvZpHFO68WvBX8Y6/view?usp=sharing', EPS: 'https://drive.google.com/file/d/1MTWVMZDaEK1dFz8-oebmiIlZXW6-FiwV/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1tWuLrMlvOeaO8z2zdZJY8udnovZAKyN3/view?usp=sharing' }, category: 'Clipart', likes: 210 },
    { id: 2006, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/WWGbLHpb/wedding-couple-Illutraction-62.jpg'], downloadFormats: { PNG: 'https://drive.google.com/file/d/1xb6h7DIii7W8GFZz_Uuh4-cXWud_-Fmw/view?usp=sharing', EPS: 'https://drive.google.com/file/d/1g3iu6YvUIng8W3OXPR0e29wsRKvmmLwA/view?usp=sharing', JPG: 'https://drive.google.com/file/d/1RCxJGNGF7T7vpFRSY-0D_LXxTVfPuu8G/view?usp=sharing' }, category: 'Clipart', likes: 210 },
    { id: 2007, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/spTTffW7/wedding-couple-Illutraction-65.jpg'], downloadFormats: { PNG: '#', JPG: '#' }, category: 'Clipart', likes: 210 },
    { id: 2008, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/spTTffW7/wedding-couple-Illutraction-65.jpg'], downloadFormats: { PNG: '#', JPG: '#' }, category: 'Clipart', likes: 210 },
    { id: 2009, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['https://i.ibb.co/spTTffW7/wedding-couple-Illutraction-65.jpg'], downloadFormats: { PNG: '#', JPG: '#' }, category: 'Clipart', likes: 210 },
    { id: 2010, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['#'], downloadFormats: { PNG: '#', JPG: '#' }, category: 'Clipart', likes: 210 },
    { id: 2011, name: 'Flower Bouquets Clipart', price: '49', paymentLink: '#', previewImages: ['#'], downloadFormats: { PNG: '#', JPG: '#' }, category: 'Clipart', likes: 210 }
    ...
    const renderMainView = () => (
        <>
            ...
            <div className="space-y-4">
                {(template.category === 'Invitations' || template.category === 'Save-the-Date') && (
...
const ContactUsPage = () => (
    <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="space-y-4 text-lg text-gray-700">
            ...
            <p><strong>Email:</strong> <a href="mailto:support@weddingtemplatehub.com" className="text-violet-600 hover:underline">support@weddingtemplatehub.com</a></p>
            <p><strong>WhatsApp:</strong> <a href="https://wa.me/91XXXXXXXXXX" className="text-violet-600 hover:underline">+91 XXXXXXXXXX</a></p>
