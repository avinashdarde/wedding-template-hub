...
const templatesData = [
    ...
    { id: 6, name: 'Watercolor Invitation Suite', previewImages: ['https://i.ibb.co/4RJs9Yyt/wedding-invitation-tamplate.jpg'], downloadFormats: { PSD: '#', JPG: '#' }, category: 'Invitations', aiPrompt: `Draft a modern, watercolor-themed wedding invitation for [FEMALE_NAME] and [MALE_NAME]'s wedding on [WEDDING_DATE] at [ADDRESS]. Emphasize an artistic and fluid style in the wording.` },
